...
const PageConfig = {
    ...
    processParmas: {
        // info
        infoUrl: {
            url: 'demMasterPlan/getResourceDetailInfo',
            params: 'weekprogressReportId'
        },
        // save
        saveUrl: {
            url: 'demMasterPlan/editResourceDetail'
        },
        // 明细模板下载
        dowanloadDetail: {
            url: 'demMasterPlan/downloadResourceDetailTemplate',
        ...
        resourcesDetail: {
            ...
            tableList: {
                ...
                slaveColumns: [
                    ...
                    // 资源名称
                    { label: 'dialog.resourceName', prop: 'resourceDetailName', formType: 'input', maxlength: 64 },
                    // 规格
                    { label: 'fConfig.standards', prop: 'standards', formType: 'input', maxlength: 64 },
                    // 单位
                    { label: 'fConfig.unit', prop: 'unit', formType: 'input', minWidth: 120, maxlength: 64 },
                    // 数量
                    {
                        label: 'fConfig.quantity', prop: 'quantity', formType: 'number',
                ...
                // 校验
                rules: {
                    resourceDetailName: [{ required: true, trigger: 'blur' }],
