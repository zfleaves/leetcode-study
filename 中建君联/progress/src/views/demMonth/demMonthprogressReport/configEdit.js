/*
 * @Author: your name
 * @Date: 2021-01-29 17:28:09
 * @LastEditTime: 2022-03-02 14:32:33
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demMonth\demMonthprogressReport\configEdit.js
 */
...
const PageConfig = {
    ...
    processParmas: {
        // 获取下一个节点的处理人信息
        nextInfo: {
            url: 'demMonthprogressReport/getWorkflowNextNode',
            parmasList: [
        ...
        // 流程审批
        approveSubmit: {
            url: 'demMonthprogressReport/setWorkflowApprove'
        },
        // 删除
        deleteParams: {
            url: 'demMonthprogressReport/setDelete',
            params: 'monthprogressReportId'
        },
        // info
        infoUrl: {
            url: 'demMonthprogressReport/getInfo',
            params: 'monthprogressReportId'
        },
        // save
        saveUrl: {
            url: 'demMonthprogressReport/setEdit'
        }
    },
    // 数据字典
    dictionary: [
    ...
    mainFormConfig: {
        formList: [
            ...
            // 项目名称
            {
                ...
                relationTable: ['progressMonthProgressReportDetai'],
                printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
            },
            // // 项目编号
            // {
            ...
            // 所属月份
            {
                label: 'demMonthprogressReport.applyMonth', prop: 'applyMonth', span: 8, formType: 'month', isRule: true,
                relationTable: ['progressMonthProgressReportDetai'], isRelation: true, isRelationTable: true, clearable: false
                // pickerOptions: {
                //     disabledDate(time) {
                //         console.log(time);
            ...
            // 预警状态
            {
                label: 'demMonthprogressReport.warnStatusValue', prop: 'warnStatusCode', span: 8, formType: 'dicSelect', selectList: []
            },
            // // 整体完成情况
            // {
            //     label: 'demMonthprogressReport.overallCompleteValue', prop: 'overallCompleteCode', span: 8, formType: 'dicSelect', selectList: []
            // },
            // 工程总体进展情况
            {
                label: 'demMonthprogressReport.overallCompleteValue', prop: 'overallCompleteValue', span: 24, formType: 'textarea', maxlength: 256,
                isRule: false, minRows: 2
            },
            // 主要完成任务及概述
            {
                label: 'demMonthprogressReport.overallTaskOverview', prop: 'overallTaskOverview', span: 24, formType: 'textarea', maxlength: 512,
                inputStatus: 'disable', minRows: 2, placeholder: 'demMonthprogressReport.overallTaskOverviewTips'
            },
            // 总计划形象进度
            {
                label: 'demMonthprogressReport.masterImageProgress', prop: 'masterImageProgress', span: 24, formType: 'textarea', maxlength: 512,
                isRule: false, minRows: 2
            },
            // 总进度计划偏差及风险分析
            {
                label: 'demMonthprogressReport.masterRiskAnalysis', prop: 'masterRiskAnalysis', span: 24, formType: 'textarea', maxlength: 512,
                isRule: false, minRows: 2
            },
            // 纠偏措施
            {
                label: 'demMonthprogressReport.correcteAction', prop: 'correcteAction', span: 24, formType: 'textarea', maxlength: 256,
                isRule: false, minRows: 2
            },
            // 附件
    ...
    subTableMatch: [
        { value: 'demMonthprogressReportDetails', assignment: 'progressMonthProgressReportDetai' }
    ],
    // 子表
    subTableConfig: {
        // 明细清单
        progressMonthProgressReportDetai: {
            subTableName: 'progressMonthProgressReportDetai',
            titleTips: 'demandMonthPlanDetailTips',
            isSelection: true,
            // 子表按钮
            subTableButton: [
                { noAuth: true, code: 'sysHandleDeletaBatch', subTableCode: 'progressMonthProgressReportDetai', disabled: false },
                { noAuth: true, code: 'sysHandleSelectDetail', subTableCode: 'progressMonthProgressReportDetai', disabled: false, name: 'demMonthprogressReport.getDetail' },
                {
                    noAuth: true, code: 'sysHandleSelectWeekDetail', subTableCode: 'progressMonthProgressReportDetai', disabled: false,
                    name: 'demMonthprogressReport.getDetailWeek', isCustom: true, icon: 'el-icon-plus'
                },
                {
                    noAuth: true, code: 'sysHandleGetApplyData', subTableCode: 'progressMonthProgressReportDetai', disabled: false,
                    name: 'demMonthprogressReport.getApplyData', isCustom: true, icon: 'el-icon-plus'
                }
                // {
                //     noAuth: true, code: 'sysHandleGetResourceData', subTableCode: 'progressMonthProgressReportDetai', disabled: false,
                //     name: 'demMonthprogressReport.getResourceData', isCustom: true, icon: 'el-icon-plus'
                // }
            ],
            tableList: {
                // 表头配置
                slaveColumns: [
                    ...
                    //  已完成进度(%)
                    {
                        label: 'demMonthprogressReport.alreadyFinishedProgress', prop: 'alreadyFinishedProgress', formType: 'slot', filterName: 'number', minWidth: 120
                    },
                    // 本月完成进度(%)
                    {
                        label: 'demMonthprogressReport.currentFinishProgress', prop: 'currentFinishProgress', formType: 'slot',
                    ...
                    // 实际完成进度(%)
                    {
                        label: 'demMonthprogressReport.realFinishProgress', prop: 'realFinishProgress', formType: 'slot',
                        operateData: true, precision: 2, maxlength: 10, minWidth: 150, minValue: 'alreadyFinishedProgress'
                    },
                    // 实际完成工作内容
                    {
                        label: 'demMonthprogressReport.realFinishContent', prop: 'realFinishContent', formType: 'input', maxlength: 255,
                        printWidth: 12, printFlag: false, defaultFlag: false, printStatus: 0, minWidth: 150
                    },
                    // 备注
                    {
                ...
                childrenSlaveColumns: [
                    ...
                    //  实际完成数量
                    {
                        label: 'demMonthprogressReport.currentDetailQuantity', prop: 'currentDetailQuantity', formType: 'number', minWidth: 120,
                        printWidth: 10, printFlag: true, defaultFlag: true, printStatus: 0, precision: 2, isRule: true
                    },
                    // 人工
                    {
                    ...
                    // 材料
                    {
                        label: 'dialog.reportMaterial', prop: 'monthprogressReportMaterials', code: '02',
                        fn: 'handleSelectResources', formType: 'slot', value: '材料'
                    },
                    // 机械
                    {
                        label: 'dialog.reportMachinery', prop: 'monthprogressReportMachineries', code: '03',
