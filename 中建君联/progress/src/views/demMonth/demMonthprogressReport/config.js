/*
 * @Author: your name
 * @Date: 2021-01-29 17:28:00
 * @LastEditTime: 2021-02-04 09:12:37
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demMonth\demMonthprogressReport\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'zmcDemandMonthPlan',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'demMonthprogressReport/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'demMonthprogressReport/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 填报月份
            { show: true, label: 'demMonthprogressReport.applyMonth', prop: 'applyMonth', span: 8, formType: 'month' },
            // 填写人
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 所属月份
            { show: true, prop: 'applyMonth', label: 'demMonthprogressReport.applyMonth', formType: 'slot', minWidth: '140' },
            // 调整原因及描述
            { show: true, prop: 'overallTaskOverview', label: 'demMonthprogressReport.overallTaskOverview', formType: 'input' },
            // 填写人
