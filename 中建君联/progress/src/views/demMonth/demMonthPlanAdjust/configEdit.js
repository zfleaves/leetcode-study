/*
 * @Author: your name
 * @Date: 2021-01-29 17:27:48
 * @LastEditTime: 2022-03-03 10:56:22
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demMonth\demMonthPlanAdjust\configEdit.js
 */
...
const PageConfig = {
    ...
    processParmas: {
        // 获取下一个节点的处理人信息
        nextInfo: {
            url: 'demMonthPlanAdjust/getWorkflowNextNode',
            parmasList: [
        ...
        // 流程审批
        approveSubmit: {
            url: 'demMonthPlanAdjust/setWorkflowApprove'
        },
        // 删除
        deleteParams: {
            url: 'demMonthPlanAdjust/setDelete',
            params: 'monthPlanAdjustId'
        },
        // info
        infoUrl: {
            url: 'demMonthPlanAdjust/getInfo',
            params: 'monthPlanAdjustId'
        },
        // save
        saveUrl: {
            url: 'demMonthPlanAdjust/setEdit'
        }
    },
    // 数据字典
    dictionary: [
        { dicCode: 'adjustTypeCode', propCode: 'adjustTypeCode' }
    ],
    // 接口数据
    selectList: [],
    // 主表
    mainFormConfig: {
        formList: [
            ...
            // 项目名称
            {
                ...
                relationTable: ['progressMonthPlanAdjustDetail'],
                printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
            },
            // // 项目编号
            // {
            ...
            // 所属月份
            {
                label: 'demMonthPlanAdjust.applyMonth', prop: 'applyMonth', span: 8, formType: 'month', isRule: true,
                relationTable: ['progressMonthPlanAdjustDetail'], isRelation: true, isRelationTable: true, clearable: false
                // pickerOptions: {
                //     disabledDate(time) {
                //         console.log(time);
            ...
            // 调整次数
            {
                label: 'demMonthPlanAdjust.adjustCount', prop: 'adjustCount', span: 8, formType: 'input', inputStatus: 'disable'
            },
            // 调整类型
            {
                label: 'demMonthPlanAdjust.adjustTypeValue', prop: 'adjustTypeCode', span: 8, formType: 'dicSelect', selectList: []
            },
            // 调整原因及描述
            {
                label: 'demMonthPlanAdjust.adjustReason', prop: 'adjustReason', span: 24, formType: 'textarea', maxlength: 256, minRows: 2,
                printWidth: 24, printFlag: true, defaultFlag: true, printStatus: 0, isRule: true
            },
            // 附件
    ...
    subTableMatch: [
        { value: 'demMonthPlanAdjustDetails', assignment: 'progressMonthPlanAdjustDetail' }
    ],
    // 子表
    subTableConfig: {
        // 明细清单
        progressMonthPlanAdjustDetail: {
            subTableName: 'progressMonthPlanAdjustDetail',
            titleTips: 'demandMonthPlanDetailTips',
            isSelection: true,
            // 子表按钮
            subTableButton: [
                { noAuth: true, code: 'sysHandleDeletaBatch', subTableCode: 'progressMonthPlanAdjustDetail', disabled: false},
                { noAuth: true, code: 'sysHandleSelectDetail', subTableCode: 'progressMonthPlanAdjustDetail', disabled: false, name: 'demMonthPlanAdjust.getDetail'}
            ],
            tableList: {
                // 表头配置
                slaveColumns: [
                    ...
                    // 实际开始日期
                    {
                        label: 'dialog.realStartDate', prop: 'realStartDate', formType: 'text', minWidth: 100,
                    ...
                    //  已完成进度(%)
                    {
                        label: 'demMonthPlanAdjust.alreadyFinishedProgress', prop: 'alreadyFinishedProgress', formType: 'slot', filterName: 'number', minWidth: 130
                    },
                    //  调整前完成进度(%)
                    {
                        label: 'demMonthPlanAdjust.oldCurrentFinishProgress', prop: 'oldCurrentFinishProgress', formType: 'slot', filterName: 'number', minWidth: 140
                    },
                    // 调整后计划完成(%)
                    {
                        label: 'demMonthPlanAdjust.currentFinishProgress', prop: 'currentFinishProgress', formType: 'slot',
                ...
                childrenSlaveColumns: [
                    ...
                    //  调整前计划完成
                    {
                        label: 'demMonthPlanAdjust.beforeAdjustDetailQuantity', prop: 'beforeAdjustDetailQuantity', formType: 'text', minWidth: 120,
                        printWidth: 10, printFlag: true, defaultFlag: true, printStatus: 0, precision: 2, isRule: true
                    },
                    //  调整后计划完成
                    {
                        label: 'demMonthPlanAdjust.currentDetailQuantity', prop: 'currentDetailQuantity', formType: 'number', minWidth: 120,
                        printWidth: 10, printFlag: true, defaultFlag: true, printStatus: 0, precision: 2, isRule: true
                    },
                    // 备注
                    {
                        label: 'fConfig.remarks', prop: 'remarks', formType: 'text', maxlength: 255,
                        printWidth: 12, printFlag: false, defaultFlag: false, printStatus: 0
                    }
                    // // 操作
                    // {
