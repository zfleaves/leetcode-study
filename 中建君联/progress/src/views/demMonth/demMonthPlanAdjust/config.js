/*
 * @Author: your name
 * @Date: 2021-01-29 17:27:37
 * @LastEditTime: 2021-02-04 09:11:02
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demMonth\demMonthPlanAdjust\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'progressMonthPlanAdjust',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'demMonthPlanAdjust/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'demMonthPlanAdjust/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 填报月份
            { show: true, label: 'demMonthPlanAdjust.applyMonth', prop: 'applyMonth', span: 8, formType: 'month' },
            // 填写人
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 所属月份
            { show: true, prop: 'applyMonth', label: 'demMonthPlanAdjust.applyMonth', formType: 'slot', minWidth: '140' },
            // 调整原因及描述
            { show: true, prop: 'adjustReason', label: 'demMonthPlanAdjust.adjustReason', formType: 'input' },
            // 填写人
