/*
 * @Author: your name
 * @Date: 2021-01-26 09:57:53
 * @LastEditTime: 2021-11-01 14:30:45
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\buildLog\buildLogOther\config.js
 */
...
const PageConfig = {
    ...
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'buildLogOther/getStartNode',
            parmasList: [
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 日期
            {
                label: 'buildLogOther.applyDate', span: 8, formType: 'daterange-split',
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 日期
            { show: true, filterName: 'date', prop: 'applyDate', label: 'buildLogOther.applyDate', minWidth: '100' },
            // 项目名称
            { show: true, prop: 'projectName', label: 'fConfig.projectName' },
            // 日志类型
            { show: true, prop: 'logTypeName', label: 'buildLogOther.logTypeName', minWidth: '120' },
            // 施工/生产情况(明日完成)
            { show: true, prop: 'finishedSituation', label: 'buildLogOther.finishedSituation' },
            // 附件
