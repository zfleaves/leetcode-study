 ...
 * @LastEditTime: 2021-11-01 14:32:45
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\buildLog\buildLogApply\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'progressBulildlogapply',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'buildLogApply/getStartNode',
            parmasList: [
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 日期
            {
                label: 'buildLogApply.applyDate', span: 8, formType: 'daterange-split',
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 施工/生产情况(今日完成)
            { show: true, prop: 'finishedSituation', label: 'buildLogApply.finishedSituation' },
            // 日期
            { show: true, filterName: 'date', prop: 'applyDate', label: 'buildLogApply.applyDate', minWidth: '100' },
            // 附件
