 ...
 * @LastEditTime: 2022-03-03 15:42:31
        ...
        resourcesDetail: {
            ...
            tableList: {
                ...
                slaveColumns: [
                    ...
                    // 名称
                    { label: 'dialog.costMaterialName', prop: 'resourceDetailName', formType: 'slot', maxlength: 64 },
                    // 规格
                    ...
                    // // 已投入数量
                    // {
                    //     label: 'fConfig.alreadyQuantity', prop: 'alreadyQuantity', formType: 'text',
                    //     operateData: true, precision: 4, maxlength: 10, minWidth: 100, min: 0
                    // },
                    // 本次投入数量
                    {
                        label: 'dialog.currentQuantity', prop: 'quantity', formType: 'number',
