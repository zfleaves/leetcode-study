<!--
 * @Author: your name
 * @Date: 2021-01-26 10:00:17
 * @LastEditTime: 2021-02-02 10:42:26
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\imageProgress\imageProgressWork\imageProgressWorkEdit.vue
-->
<template>
    <div>
        ...
        <g-dialog v-if="dialogVisible" :dialogConfig="dialogConfig" :isVisible.sync="dialogVisible">
            <taskDetail slot="body" slot-scope="{height}" :dialogHeight="height"
                :selectId='pageConfig.projectForm.progressTaskCid || 0'
...
export default {
    ...
    data () {
        return {
            ...
            dialogVisible: false,
            dialogConfig: {
                title: this.$t('imageProgressWork.seleTaskName'),
                appendBody: false,
                center: true,
                top: '50px',
                width: '60%',
