...
const PageConfig = {
    formCode: 'progressImageWork',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'imageProgressWork/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'imageProgressWork/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 任务名称
            { show: true, prop: 'progressTaskName', label: 'imageProgressWork.progressTaskName' },
            // 附件
