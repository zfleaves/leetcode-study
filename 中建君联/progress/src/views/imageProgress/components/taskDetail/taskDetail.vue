<!--
 * @Author: your name
 * @Date: 2021-01-26 17:21:41
 * @LastEditTime: 2021-02-04 14:44:27
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\imageProgress\components\taskDetail\taskDetail.vue
-->
<template>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        mainTable: {
            ...
            tableList: [
                ...
                // 责任人
                {show: true, prop: 'dutyUserName', label: 'dialog.dutyUserName', minWidth: '120'},
                // 计划工期(days)
                {show: true, prop: 'planDuration', label: 'dialog.planDuration', minWidth: '120'},
                // 计划开始日期
        ...
        selectMainTable: {
            ...
            tableList: [
                ...
                {show: true, prop: 'planDuration', label: 'dialog.planDuration', minWidth: '120'},
                // 单位
                {show: true, prop: 'startDate', label: 'dialog.start_date', minWidth: '120', filterName: 'date'}
            ]
        },
        taskName: '',
        // =====================
    ...
    async created () {
      ...
      this.varietiesDateilUrl = 'demMonthPlan/getProjectMainInfo';
    ...
    methods: {
        ...
        handleNodeCheckChange(data) {
          ...
          this.setSelectMainTable(this.mainTable.tableData, data);
        },
        // 处理右边选中数据
        ...
        handleDialogStatus(status) {
            if (status === 'close') {
                ...
                if (this.selectMainTable.tableData.length === 0) {
                    this.$message.error(this.$t('dialog.demMasterPlanTaskTips'));
                    return;
                }
