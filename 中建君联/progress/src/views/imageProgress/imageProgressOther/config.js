...
const PageConfig = {
    formCode: 'progressImageOther',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'imageProgressOther/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'imageProgressOther/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 任务名称
            { show: true, prop: 'progressTaskName', label: 'imageProgressOther.progressTaskName' },
            // 附件
