/*
 * @Author: your name
 * @Date: 2021-01-26 17:35:26
 * @LastEditTime: 2021-02-02 13:45:39
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demMaster\demMasterPlan\config.js
 */
...
const PageConfig = {
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 计划开始日期
            { show: true, filterName: 'date', prop: 'planStartDate', label: 'demMasterPlan.planStartDate', minWidth: '120' },
            // 计划完成日期
            { show: true, prop: 'planFinishedDate', label: 'demMasterPlan.planFinishedDate', filterName: 'date', minWidth: '120' },
