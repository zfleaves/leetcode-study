/*
 * @Author: your name
 * @Date: 2021-01-28 09:03:44
 * @LastEditTime: 2021-02-05 11:56:07
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demMaster\demMasterPlanAdjust\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'progressMasterPlanAdjust',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'demMasterPlanAdjust/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'demMasterPlanAdjust/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // // 计划开始日期
            // { show: true, filterName: 'date', prop: 'planStartDate', label: 'demMasterPlanAdjust.planStartDate', minWidth: '100' },
            // // 计划完成日期
            // { show: true, prop: 'planFinishedDate', label: 'demMasterPlanAdjust.planFinishedDate', filterName: 'date', minWidth: '100' },
            // 填写人
            { show: true, prop: 'createByName', label: 'fConfig.createByName', minWidth: '120' },
            // 填写日期
            { show: true, filterName: 'date', prop: 'createTime', label: 'fConfig.createTime', minWidth: '100' },
            // 版本号
            { show: true, prop: 'beforeVersionNumber', label: 'demMasterPlanAdjust.beforeVersionNumber', minWidth: '120', align: 'center' },
            // 调整原因
            { show: true, prop: 'adjustReason', label: 'demMasterPlanAdjust.adjustReason' },
            // 操作
            {
                show: true, formType: 'operate', label: 'fConfig.operate', minWidth: '160',
                buts: [
                    { name: 'demMasterPlanAdjust.editPlan', class: '', fn: 'handleEditPlan', authCode: 'plan', isCreateBy: true },
