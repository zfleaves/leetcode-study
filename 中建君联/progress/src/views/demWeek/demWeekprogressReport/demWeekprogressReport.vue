 ...
 * @LastEditTime: 2021-02-02 09:14:24
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demWeek\demWeekprogressReport\demWeekprogressReport.vue
-->
<template>
  <div>
    <query-page
  ...
  export default {
    ...
    methods: {
      ...
      _getTableDataList () {
        ...
        this.handleGetTableDataList('demWeekprogressReport/getPageList');
      },
      // 根据日期判断是月的第几周
      getWeekInMonth(t) {
      ...
      handleDelete(row) {
        const statusConfig = {
          keyId: 'weekprogressReportId',
          keyName: 'projectName',
          row,
          api: 'demWeekprogressReport/setDelete'
        };
