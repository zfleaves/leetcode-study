/*
 * @Author: your name
 * @Date: 2021-02-01 17:09:35
 * @LastEditTime: 2021-04-13 16:59:48
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demWeek\demWeekprogressReport\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'progressWeekProgressReport',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'demWeekprogressReport/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'demWeekprogressReport/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 填报周期
            { show: true, label: 'demWeekprogressReport.applyWeek', prop: 'applyDate', span: 8, formType: 'week' },
            // 填写人
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 填报周期
            { show: true, prop: 'applyDate', label: 'demWeekprogressReport.applyWeek', formType: 'slot', minWidth: '160' },
            // 调整原因及描述
            { show: true, prop: 'overallTaskOverview', label: 'demWeekprogressReport.overallTaskOverview', formType: 'input' },
            // 填写人
