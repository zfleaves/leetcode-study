 ...
 * @LastEditTime: 2021-04-16 11:15:33
    ...
    subTableConfig: {
        ...
        resourcesDetail: {
            ...
            tableList: {
                ...
                slaveColumns: [
                    // 数据来源
                    { label: 'dialog.dataSourceValue', prop: 'dataSourceValue', formType: 'slot', minWidth: 80 },
                    // 资源类型
                    { label: 'dialog.resourceTypeValue', prop: 'resourceTypeValue', formType: 'slot', minWidth: 100 },
                    // 资源名称
                    ...
                    // 单价(含税)
                    {
                        ...
                        operateData: false, precision: 2, minWidth: 100
                    },
                    // 税率
                    {
                    ...
                    // 税额
                    {
                        ...
                        operateData: false, precision: 2, maxlength: 12, minWidth: 80
                    },
                    // 单价(不含税)
                    {
                        label: 'dialog.excludeUnitPrice', prop: 'excludeUnitPrice', formType: 'number',
                        operateData: false, precision: 8, maxlength: 12, minWidth: 100
                    },
                    // 备注
