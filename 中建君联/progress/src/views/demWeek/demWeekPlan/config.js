/*
 * @Author: your name
 * @Date: 2021-02-01 17:08:57
 * @LastEditTime: 2021-02-04 09:14:17
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demWeek\demWeekPlan\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'progressWeekPlan',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'demWeekPlan/getStartNode',
            parmasList: [
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 填报周期
            { show: true, label: 'demWeekPlan.applyWeek', prop: 'applyDate', span: 8, formType: 'week' },
            // 填写人
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 填报周期
            { show: true, prop: 'applyDate', label: 'demWeekPlan.applyWeek', formType: 'slot', minWidth: '160' },
            // 主要工作内容及内容描述
            { show: true, prop: 'taskOverview', label: 'demWeekPlan.taskOverview', formType: 'input' },
            // 填写人
