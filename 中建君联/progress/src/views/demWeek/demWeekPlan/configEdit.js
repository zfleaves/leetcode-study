/*
 * @Author: your name
 * @Date: 2021-02-01 17:09:30
 * @LastEditTime: 2022-02-28 15:20:59
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\demWeek\demWeekPlan\configEdit.js
 */
...
const PageConfig = {
    ...
    processParmas: {
        // 获取下一个节点的处理人信息
        nextInfo: {
            url: 'demWeekPlan/getWorkflowNextNode',
            parmasList: [
        ...
        // 流程审批
        approveSubmit: {
            url: 'demWeekPlan/setWorkflowApprove'
        },
        // 删除
        deleteParams: {
            url: 'demWeekPlan/setDelete',
            params: 'weekPlanId'
        },
        // info
        infoUrl: {
            url: 'demWeekPlan/getInfo',
            params: 'weekPlanId'
        },
        // save
        saveUrl: {
            url: 'demWeekPlan/setEdit'
        }
    },
    // 数据字典
    dictionary: [
    ...
    mainFormConfig: {
        formList: [
            ...
            // 项目名称
            {
                ...
                relationTable: ['progressWeekPlanDetail'],
                printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
            },
            // 填报周期
            {
                label: 'demWeekPlan.applyWeek', prop: 'applyDate', span: 8, formType: 'week', check: true, isRule: true, filterName: 'week',
                relationTable: ['progressWeekPlanDetail'], isRelation: true, isRelationTable: true, clearable: false,
                printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
            },
            // 周度主要任务概述
            {
                label: 'demWeekPlan.taskOverview', prop: 'taskOverview', span: 24, formType: 'textarea', maxlength: 256,
                printWidth: 24, printFlag: true, defaultFlag: true, printStatus: 0, minRows: 2
            },
            // 风险预估
            {
                label: 'demWeekPlan.riskEstimate', prop: 'riskEstimate', span: 24, formType: 'textarea', maxlength: 256,
                printWidth: 24, printFlag: true, defaultFlag: true, printStatus: 0, minRows: 2
            },
            // 资源需求计划
            {
                label: 'demWeekPlan.resourceRequiredPlan', prop: 'resourceRequiredPlan', span: 24, formType: 'textarea', maxlength: 256,
                printWidth: 24, printFlag: true, defaultFlag: true, printStatus: 0, minRows: 2
            },
            // 附件
    ...
    subTableMatch: [
        { value: 'demWeekPlanDetails', assignment: 'progressWeekPlanDetail' }
    ],
    // 子表
    subTableConfig: {
        // 明细清单
        progressWeekPlanDetail: {
            subTableName: 'progressWeekPlanDetail',
            titleTips: 'demandMonthPlanDetailTips',
            isSelection: true,
            // 子表按钮
            subTableButton: [
                { noAuth: true, code: 'sysHandleDeletaBatch', subTableCode: 'progressWeekPlanDetail', disabled: false },
                { noAuth: true, code: 'sysHandleSelectDetail', subTableCode: 'progressWeekPlanDetail', disabled: false }
            ],
            tableList: {
                // 表头配置
                slaveColumns: [
                    ...
                    //  已完成进度(%)
                    {
                        label: 'demWeekPlan.alreadyFinishedProgress', prop: 'alreadyFinishedProgress', formType: 'slot', filterName: 'number',
                        minWidth: 150, printWidth: 10, printFlag: true, defaultFlag: true, printStatus: 0
                    },
                    // 本月完成进度
                    {
                        label: 'demWeekPlan.currentFinishProgress', prop: 'currentFinishProgress', formType: 'slot',
