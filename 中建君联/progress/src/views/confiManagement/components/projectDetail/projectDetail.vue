<!--
 * @Author: your name
 * @Date: 2020-07-20 15:11:24
 * @LastEditTime: 2020-08-26 17:09:46
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_project-项目前期管理\src\views\projectManage\components\projectDetail\projectDetail.vue
-->
<template>
    ...
    methods: {
      ...
      // 获取表单
        _getTableDataList () {
            ...
            this.$store.dispatch('projectCalendar/getProjectPermissonPage', data).then(res => {
            if (res.status === 0) {
