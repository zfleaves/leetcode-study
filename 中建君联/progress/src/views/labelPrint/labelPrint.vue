    ...
    <div class="deliverGoodsWrap">
      <div class="roleCons">
        ...
        <div class="search_cons">
          <el-form :models="searchForm" ref="searchForm" label-width="120px" class="demo-ruleForm">
            <el-row :gutter="20">
              <el-col :span="6">
                  <!-- 打印设备名称 -->
                <el-form-item :label="$t('print.equipmentName')" prop="equipmentCode">
                  <el-select
                    size="small" v-models="searchForm.equipmentCode"
              ...
              <el-col :span="6">
                ...
                <el-form-item :label="$t('print.equipmentCode')" prop="equipmentCode">
                  <el-input
                    v-models="searchForm.equipmentCode"
              ...
              <el-col :span="6">
                ...
                <el-form-item :label="$t('print.printSize')" prop="sizeId">
                  <el-select
                    ...
                    size="small" v-models="searchForm.sizeId">
                    <el-option
        ...
        <div class="content">
          <div class="choice">
            ...
            <el-checkbox
              ...
              v-models="checkAll" @change="handleCheckAllChange">
