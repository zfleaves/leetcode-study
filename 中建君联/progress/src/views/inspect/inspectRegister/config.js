/*
 * @Author: your name
 * @Date: 2021-01-26 10:02:11
 * @LastEditTime: 2021-01-26 16:30:27
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\inspect\inspectRegister\config.js
 */
import Utils from 'util';

const PageConfig = {
    formCode: 'progressInspectRegister',
    // 流程
    processParmas: {
        // 初始化信息
        startInfo: {
            url: 'inspectRegister/getStartNode',
            parmasList: [
        ...
        // 提交
        startSubmit: {
            url: 'inspectRegister/startSubmit'
        }
    },
    // 数据字典
    dictionary: [],
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 巡检日期
            {
                label: 'inspectRegister.inspectDate', span: 8, formType: 'daterange-split',
                propStart: 'inspectDateFrom', propEnd: 'inspectDateTo',
                inputStatus: 'edit'
            }
        ],
        // 是否显示重置按钮
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 巡检日期
            { show: true, filterName: 'date', prop: 'inspectDate', label: 'inspectRegister.inspectDate', minWidth: '100' },
            // 项目名称
