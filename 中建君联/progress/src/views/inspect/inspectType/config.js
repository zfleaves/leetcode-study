/*
 * @Author: your name
 * @Date: 2021-01-26 10:02:45
 * @LastEditTime: 2021-02-04 09:16:50
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectprogress-项目进度管理云\src\views\inspect\inspectType\config.js
 */
...
const PageConfig = {
    ...
    searchControls: {
        ...
        formList: [
            ...
            // 分类名称
            { show: true, label: 'inspectType.inspectTypeName', prop: 'inspectTypeName', span: 8, formType: 'input', maxlength: 64 },
            // 分类编号
            { show: true, label: 'inspectType.inspectTypeCode', prop: 'inspectTypeCode', span: 8, formType: 'input', maxlength: 32 },
            // 备注
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 分类名称
            { show: true, prop: 'inspectTypeName', label: 'inspectType.inspectTypeName' },
            // 分类编号
            { show: true, prop: 'inspectTypeCode', label: 'inspectType.inspectTypeCode', fn: 'handleSetRouter', minWidth: '120' },
            // 同级排序
            { show: true, prop: 'sort', label: 'inspectType.sort', minWidth: '100' },
            // 备注
    ...
    mainFormConfig: {
        formList: [
            // 分类名称
            { label: 'inspectType.inspectTypeName', prop: 'inspectTypeName', span: 24, formType: 'input', isRule: true, maxlength: 64 },
            // 分类编号
            { label: 'inspectType.inspectTypeCode', prop: 'inspectTypeCode', span: 24, formType: 'input', maxlength: 32 },
            // 同级排序
            { label: 'inspectType.sort', prop: 'sort', span: 24, formType: 'elNumber', precision: 0, min: 0, maxlength: 10 },
            // 备注
...
class Page {
    constructor() {
        ...
        // console.log(i18n.t('inspectType.address'));
