 ...
 * @LastEditTime: 2021-07-28 09:22:06
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\subcontractorMaterial\materialApproach\config.js
 */
import Utils from 'util';

const PageConfig = {
  formCode: 'subcontractMaterialEnter',
  // 流程
  processParmas: {
    // 初始化信息
    startInfo: {
      url: 'materialApproach/getStartNode',
      parmasList: [
    ...
    // 提交
    startSubmit: {
      url: 'materialApproach/startSubmit'
    }
  },
  // 数据字典
  dictionary: [
  ...
  searchControls: {
    ...
    formList: [
      ...
      // 分包商名称
      {show: true, label: 'materialApproach.projectUnitName', prop: 'projectUnitName', span: 8, formType: 'input', maxlength: 64},
      // 主要进场材料
      {show: true, label: 'materialApproach.mainEnterMaterial', prop: 'mainEnterMaterial', span: 8, formType: 'input', maxlength: 64},
      // 登记人
      {show: true, label: 'materialApproach.registerName', prop: 'registerName', span: 8, formType: 'input', maxlength: 64},
      // 进场日期
      {label: 'materialApproach.enterTime', span: 8, formType: 'daterange-split',
            propStart: 'enterTimeFrom', propEnd: 'enterTimeTo',
            inputStatus: 'edit'}
    ],
    // 是否显示重置按钮
    isReset: true
  ...
  mainTable: {
    ...
    tableList: [
      ...
      // 分包商名称
      {show: true, prop: 'projectUnitName', label: 'materialApproach.projectUnitName'},
      // 主要进场材料
      {show: true, prop: 'mainEnterMaterial', label: 'materialApproach.mainEnterMaterial'},
      // 登记人
      {show: true, prop: 'registerName', label: 'materialApproach.registerName', minWidth: '100'},
      // 进场日期
      {show: true, filterName: 'date', prop: 'enterTime', label: 'materialApproach.enterTime', minWidth: '100'},
      // 操作
