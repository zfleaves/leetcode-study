 ...
 * @LastEditTime: 2021-11-05 12:42:28
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\promaterial\compoent\invoiceMultiple\invoiceMultiple.vue
-->
<template>
  ...
  export default {
    ...
    methods: {
        ...
        _getTableDataList () {
            ...
            this.handleGetTableDataList('purchaseSettlement/getInvoiceList', false, () => {
