<!--
 * @Author: your name
 * @Date: 2020-08-03 09:12:04
 * @LastEditTime: 2021-04-15 11:57:54
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\promaterial\compoent\supplyOrder\supplyOrder.vue
-->
<template>
  ...
  export default {
    ...
    methods: {
      ...
      _getTableDataList () {
        ...
        this.handleGetTableDataList('checkArrival/getSupplyorderCheckarival', false);
      },
