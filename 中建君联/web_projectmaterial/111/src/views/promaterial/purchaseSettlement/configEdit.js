...
const PageConfig = {
  ...
  processParmas: {
    // 获取下一个节点的处理人信息
    nextInfo: {
      url: 'purchaseSettlement/getWorkflowNextNode',
      parmasList: [
    ...
    // 流程审批
    approveSubmit: {
      url: 'purchaseSettlement/setWorkflowApprove'
    },
    // 删除
    deleteParams: {
      url: 'purchaseSettlement/setDelete',
      params: 'settlementId'
    },
    // 删除明细
    deleteDetailsParams: {
      url: 'purchaseSettlement/setDeleteDetails'
    },
    // info
    infoUrl: {
      url: 'purchaseSettlement/getInfo',
      params: 'settlementId'
    },
    // save
    saveUrl: {
      url: 'purchaseSettlement/setEdit'
    },
    // 导出明细
    exportDetail: {
      url: 'purchaseSettlement/exportDetail',
      params: 'settlementId'
    },
    // 下载模板
    dowanloadDetail: {
      url: 'purchaseSettlement/getDownloadTemplate',
  ...
  mainFormConfig: {
    formList: [
      ...
      // 项目名称
      {
        ...
        { receive: 'projectNatureValue', value: 'projectNatureValue' },
        { receive: 'projectNatureCode', value: 'projectNatureCode' },
        { receive: 'masterCostControl', value: 'masterCostControl' },
        { receive: 'settlementCostControl', value: 'settlementCostControl' }],
        isRule: true,
        relationTable: ['purchaseSettlementDetail'],
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
      },
      // 项目编号
      {
      ...
      // 合同/零星采购单
      {
        label: 'fConfig.contractSporadicPurchaseName', prop: 'contractName', span: 8, formType: 'slot', isRule: true,
        key: 'contractId', relationKey: { receive: 'projectId', value: 'projectName' },
        isRelation: true,
        relationList: [
      ...
      // 累计已结算
      {
        label: 'dialog.settlementTotalAmount', prop: 'totalSettlementAmount', span: 8, formType: 'settlementAmount', precision: 2,
        inputStatus: 'disable', setUrl: 'purchaseSettlement/getPageList', contractKey: 'contractId', jumpToUrl: 'purchaseSettlement', ownPage: true,
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0, filterName: 'setMoney'
      },
      // 累计已收票
      {
        label: 'dialog.totalInvoiceAmount', prop: 'totalInvoiceAmount', span: 8, formType: 'InvoiceAmount', precision: 2, inputStatus: 'disable',
      ...
      // 累计已支付
      {
        label: 'dialog.paymentTotalAmount', prop: 'totalPaymentAmount', span: 8, formType: 'paymentAmount', precision: 2, inputStatus: 'disable',
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0, filterName: 'setMoney', jumpToUrl: 'paymentApply', ownPage: false,
        setUrl: 'paymentApply/getPageList', contractKey: 'contractId'
      },
      // // 累计已结算
      // {
      //   label: 'dialog.settlementTotalAmount', prop: 'totalSettlementAmount', span: 8, formType: 'input', inputStatus: 'disable',
      //   printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0, filterName: 'setMoney'
      // },
      // // 累计已支付
      // {
      //   label: 'dialog.paymentTotalAmount', prop: 'totalPaymentAmount', span: 8, formType: 'input', inputStatus: 'disable',
      //   printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0, filterName: 'setMoney'
      // },
      // // 累计已开票
      // {
      //   label: 'dialog.totalInvoiceAmount', prop: 'totalInvoiceAmount', span: 8, formType: 'input', inputStatus: 'disable',
      //   printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0, filterName: 'setMoney'
      // },
      // // 合同名称
      // {
      //   label: 'purchaseSettlement.contractName', prop: 'contractName', span: 8, formType: 'slot', key: 'contractId',
      //   isRelation: true,
      //   relationList: [
      //     { receive: 'supplierName', value: 'partyBUnitName' },
      //     { receive: 'supplierId', value: 'partyBUnitId' },
      ...
      // 供应商
      {
        label: 'purchaseSettlement.supplierName', prop: 'supplierName', span: 8, formType: 'input',
        inputStatus: 'disable', placeholder: 'purchaseSettlement.supplierNameTips', // 选择合同后自动带入
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
      },
      // 乙方申报金额
      {
        label: 'fConfig.partyBDeclareAmount', prop: 'partyBDeclareAmount', span: 8, formType: 'elNumber', min: 0, precision: 2,
        maxlength: 12, filterName: 'setMoney',
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
      },
      // 结算办理人
      {
        label: 'purchaseSettlement.settlementAgentUserName', prop: 'settlementAgentUserName', span: 8,
        isRule: true, formType: 'userRadio', maxlength: 32, key: 'settlementAgentUserId',
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
      },
      // 结算日期
      {
      ...
      // 币种
      {
        label: 'purchaseSettlement.currencyValue', prop: 'currencyValue', span: 8, formType: 'input', inputStatus: 'disable',
        printWidth: 8, printFlag: true, defaultFlag: true, printStatus: 0
      },
      // 入库单编号
      {
      ...
      // 用途或备注
      { label: 'purchaseSettlement.remarks', prop: 'remarks', span: 24, formType: 'textarea', maxlength: 256,
  ...
  subTableConfig: {
    ...
    purchaseSettlementDetail: {
      ...
      // 子表按钮
      subTableButton: [
        { noAuth: true, code: 'sysHandleDeletaBatch', subTableCode: 'purchaseSettlementDetail', disabled: false },
        // 导出明细
        { noAuth: true, code: 'sysHandleExportDetail', subTableCode: 'purchaseSettlementDetail', name: 'button.export', authCode: 'export' },
        { noAuth: true, code: 'sysHandleSelectDetail', subTableCode: 'purchaseSettlementDetail', disabled: false },
        // 全量结算
        { isCustom: true, noAuth: true, code: 'sysFullSettlement', name: 'purchaseSettlement.fullsettlement', subTableCode: 'purchaseSettlementDetail', icon: 'el-icon-magic-stick',
        slot: true, disabled: false },
        // 合并填价
        { isCustom: true, noAuth: true, code: 'sysMergeFillPrice', name: 'purchaseSettlement.mergeFillPrice', subTableCode: 'purchaseSettlementDetail',
        slot: true, disabled: false }
      ],
      ASubTableButton: [
        { noAuth: true, code: 'sysHandleDeletaBatch', subTableCode: 'purchaseSettlementDetail', disabled: false },
      ...
      BSubTableButton: [
        // 添加明细
        { noAuth: true, code: 'sysHandleDeletaAdd', subTableCode: 'purchaseSettlementDetail', disabled: false},
        // 选择明细
        { noAuth: true, code: 'sysHandleSelectDetail', subTableCode: 'purchaseSettlementDetail', disabled: false },
        // 合并填价
        { isCustom: true, noAuth: true, code: 'sysMergeFillPrice', name: 'purchaseSettlement.mergeFillPrice', subTableCode: 'purchaseSettlementDetail',
        slot: true, disabled: false },
        // 下载模板
        { noAuth: true, code: 'sysHandleDownloadTemplate', subTableCode: 'purchaseSettlementDetail', name: 'button.downloadTemplate', disabled: false },
        // 导入明细
        { noAuth: true, code: 'sysHandleImport', subTableCode: 'purchaseSettlementDetail', name: 'button.Import', disabled: false, slot: true },
        { noAuth: true, code: 'sysHandleDeletaBatch', subTableCode: 'purchaseSettlementDetail', disabled: false }
      ],
      ...
      tableList: {
        ...
        slaveColumns: [
          ...
          //  本次结算数量
          {
            label: 'purchaseSettlement.currentSettlementQuantity', prop: 'currentSettlementQuantity', formType: 'slot',
          ...
          // 重量
          {
            label: 'fConfig.weight', prop: 'weight', formType: 'number', precision: 2, min: 0, maxlength: 12, minWidth: 100,
            printWidth: 12, printFlag: true, defaultFlag: true, printStatus: 0
          },
          ...
          // 操作
          { formType: 'operate', label: 'fConfig.operate', minWidth: '120',
            isProjectNatureAShow: true
            // buts: [
            //   // 添加其他款项
            //   {name: 'button.addOtherPayments', class: 'warning', fn: 'handleAddOtherPayments', noAuth: true}
            // ]
          }
        ],
        // 校验
    ...
    mergeFillPrice: {
      subTableName: 'mergeFillPrice',
      titleTips: 'mergeFillPriceTitleTips',
      isSelection: false,
      tableList: {
        // 表头配置
        slaveColumns: [
          // 材料名称
          {
            label: 'fConfig.materialName', prop: 'materialName', formType: 'text'
          },
          // 规格
          {
            label: 'fConfig.standards', prop: 'standards', minWidth: 120, formType: 'text'
          },
          // 型号
          {
            label: 'fConfig.models', prop: 'models', minWidth: 120, formType: 'text'
          },
          // 品牌
          {
            label: 'fConfig.brand', prop: 'brand', minWidth: 120, formType: 'text'
          },
          // 计量单位
          {
            label: 'fConfig.unit', prop: 'unit', minWidth: 80, formType: 'text'
          },
          //  结算总数量
          {
            label: 'purchaseSettlement.settlementTotalQuantity', prop: 'settlementTotalQuantity', minWidth: 100, formType: 'text'
          },
          //  结算单价(含税)
          {
            label: 'fConfig.settlementIncludeUnitPrice', prop: 'settlementIncludeUnitPrice', formType: 'number', precision: 2
          }
        ],
