 ...
 * @LastEditTime: 2020-08-24 15:53:17
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\promaterial\warReturngoods\config.js
 */
import Utils from 'util';

const PageConfig = {
  formCode: 'warehouseReturngoods',
  // 流程
  processParmas: {
    // 初始化信息
    startInfo: {
      url: 'warReturngoods/getStartNode',
      parmasList: [
    ...
    // 提交
    startSubmit: {
      url: 'warReturngoods/startSubmit'
    }
  },
  // 数据字典
  dictionary: [],
  ...
  searchControls: {
    ...
    formList: [
      ...
      // 主要退货材料
      {show: true, label: 'warReturngoods.mainReturngoodsMaterials', prop: 'mainReturngoodsMaterials', span: 8, formType: 'input', maxlength: 128},
      // 供应商名称
      {show: true, label: 'warReturngoods.supplierName', prop: 'supplierName', span: 8, formType: 'input', maxlength: 64},
      // 退货日期
      {label: 'warReturngoods.returngoodsDate', span: 8, formType: 'daterange-split',
            propStart: 'returngoodsDateFrom', propEnd: 'returngoodsDateTo',
            inputStatus: 'edit'}
    ],
    // 是否显示重置按钮
    isReset: true
  ...
  mainTable: {
    ...
    tableList: [
      ...
      // 供应商名称
      {show: true, prop: 'supplierName', label: 'warReturngoods.supplierName'},
      // 主要退货材料
      {show: true, prop: 'mainReturngoodsMaterials', label: 'warReturngoods.mainReturngoodsMaterials'},
      // 价税合计
      {show: true, prop: 'totalPriceTax', label: 'warReturngoods.totalPriceTax', minWidth: '100', formType: 'setMoney', filterName: 'setMoney'},
      // 项目名称
      {show: true, prop: 'projectName', label: 'fConfig.projectName'},
      // 退货办理人
      {show: true, prop: 'returngoodsAgentUserName', label: 'warReturngoods.returngoodsAgentUserName', minWidth: '100'},
      // 退货日期
      {show: true, filterName: 'date', prop: 'returngoodsDate', label: 'warReturngoods.returngoodsDate', minWidth: '100'},
      // 操作
