/*
 * @Author: your name
 * @Date: 2020-07-24 15:15:51
 * @LastEditTime: 2020-08-24 15:44:49
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\demandPlan\yearPlan\config.js
 */
import Utils from 'util';

const PageConfig = {
  formCode: 'demandYearPlan',
  // 流程
  processParmas: {
    // 初始化信息
    startInfo: {
      url: 'yearPlan/getStartNode',
      parmasList: [
  ...
  searchControls: {
    ...
    formList: [
      ...
      // 填报年度
      {show: true, label: 'yearPlan.applyYear', prop: 'applyYear', span: 8, formType: 'year'},
      // 填写人
  ...
  mainTable: {
    ...
    tableList: [
      ...
      // 项目编号
      {show: true, prop: 'projectCode', label: 'fConfig.projectCode', minWidth: '140'},
      // 填报年度
      {show: true, prop: 'applyYear', label: 'yearPlan.applyYear', minWidth: '140'},
      // 需求明细
      {show: true, prop: 'detailItem', label: 'yearPlan.detailItem', formType: 'slot', minWidth: '120'},
      // 填写人
