/*
 * @Author: your name
 * @Date: 2020-07-24 15:24:53
 * @LastEditTime: 2021-12-28 13:58:14
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\demandPlan\weekPlan\config.js
 */
import Utils from 'util';

const PageConfig = {
  formCode: 'demandWeekPlan',
  // 流程
  processParmas: {
    // 初始化信息
    startInfo: {
      url: 'weekPlan/getStartNode',
      parmasList: [
  ...
  searchControls: {
    ...
    formList: [
      ...
      // 填报周期
      {show: true, label: 'weekPlan.applyWeek', prop: 'applyDate', span: 8, formType: 'week'},
      // 填写人
  ...
  mainTable: {
    ...
    tableList: [
      ...
      // 填报周期
      {show: true, prop: 'applyDate', label: 'weekPlan.applyWeek', formType: 'slot', minWidth: '140'},
      // 需求明细
      {show: true, prop: 'detailItem', label: 'weekPlan.detailItem', formType: 'slot'},
      // 主要需求明细
      ...
      // 是否下单
      {show: true, prop: 'ifFastSporadicPurchase', label: 'weekPlan.ifFastSporadicPurchase', minWidth: '120', formType: 'slot', align: 'center'},
      // 操作
