/*
 * @Author: your name
 * @Date: 2020-07-24 15:14:51
 * @LastEditTime: 2022-06-20 17:07:13
 * @LastEditors: wumaoxia 1805428335@qq.com
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\demandPlan\masterPlan\config.js
 */
...
const PageConfig = {
  ...
  mainTable: {
    ...
    // 子系统表头渲染参数
    tableList: [
      // 材料执行策划Page页面基本不变，增加“策划次数、策划内容概述”字段，原本两个金额字段去掉，更改为策划总金额字段。
      // 审批状态
      ...
      // 策划次数
      { show: true, prop: 'schemeNum', label: 'masterPlan.schemeNum', formType: 'slot', minWidth: '100' },
      // 策划内容概述
      { show: true, prop: 'schemeContent', label: 'masterPlan.schemeContent'},
      // 策划总金额
      { show: true, prop: 'afterBudgetTotalAmount', label: 'masterPlan.afterBudgetTotalAmount', formType: 'setMoney', filterName: 'setMoney', minWidth: '160' },
      // 填写人
