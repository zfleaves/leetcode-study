 ...
 * @LastEditTime: 2021-12-28 11:33:04
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web_projectmaterial\src\views\demandPlan\monthPlan\config.js
 */
import Utils from 'util';

const PageConfig = {
  formCode: 'demandMonthPlan',
  // 流程
  processParmas: {
    // 初始化信息
    startInfo: {
      url: 'monthPlan/getStartNode',
      parmasList: [
  ...
  searchControls: {
    ...
    formList: [
      ...
      // 填报月份
      {show: true, label: 'monthPlan.applyMonth', prop: 'applyMonth', span: 8, formType: 'month'},
      // 填写人
  ...
  mainTable: {
    ...
    tableList: [
      ...
      // 填报月份
      {show: true, prop: 'applyMonth', label: 'monthPlan.applyMonth', formType: 'slot', minWidth: '120'},
      // 需求明细
      {show: true, prop: 'detailItem', label: 'monthPlan.detailItem', formType: 'slot', minWidth: '100'},
      // 需求明细
      { show: true, prop: 'mainDemandDetail', label: 'fConfig.mainDemandDetailNew'},
      // 填写人
      ...
      // 是否下单
      {show: true, prop: 'ifFastSporadicPurchase', label: 'monthPlan.ifFastSporadicPurchase', minWidth: '120', formType: 'slot', selectList: [
        {dataName: '是', dataCode: 1}, {dataName: '否', dataCode: 0}], align: 'center'
      },
      // 操作
      {show: true, formType: 'operate', label: 'fConfig.operate', minWidth: '180',
      buts: [
          // 快速下单
          // {name: 'monthPlan.quickOrder', class: 'success', fn: 'handleQuickOrder', authCode: 'quickOrder', isCreateBy: false, noAuth: true, enable: true },
