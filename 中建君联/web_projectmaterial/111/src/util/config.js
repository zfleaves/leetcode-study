 ...
 * @LastEditTime: 2022-05-31 15:25:24
...
const Config = {
    ...
    dataList: [
        ...
        { name: '预算类型', id: 147, code: 'demandType'},
        { name: '物资类别', id: 174, code: 'materialClassifyCode'},
        { name: '拟供应来源', id: 175, code: 'supplySourceCode'},
        { name: '废旧物资处置-拟处理方式', id: 187, code: 'handleMethodCode'},
        { name: '计量方式', id: 188, code: 'meterageMethodCode'},
