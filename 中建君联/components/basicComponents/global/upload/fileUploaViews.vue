  ...
  <div class="file-upload uploadFileWrap">
    <div class="top" v-if="showSumbit">
      <div class="file-upload-buttons">
        <ul class="files" style="width:300px;" v-show="fileShow">
          <li v-for="item in imgUrlList" :key="item.id" :style="{ width: `calc(${100 / arrayNumber}% - 5px)` }">
            <div class="right">
              <div class="cons file-upload-buttons">
                <tooltips :value="fileNameFilvalter(item) "></tooltips>
              </div>
            </div>
          </li>
        </ul>
        ...
        <el-upload v-if="!flowStatus" style="vertical-align: middle; display: inline-block; height: 100%"
          :action="fileUrl" :headers="myHeaders" :disabled="title === $t('tips.uploadTitleLoading')" :data="fileName"
          ...
          <!-- 上传 -->
          <el-button class="file-but" :disabled="title === $t('tips.uploadTitleLoading') || flowStatus"
            v-if="title !== $t('tips.uploadTitleLoading')" style="vertical-align: middle;margin-left: 20px;"
            size="small" type="text">
            <i class="iconfont icon-shangchuandaochu"></i>{{ $t('button.upload') }}
          </el-button>
        ...
        <ul class="files" v-show="fileShow">
          <li v-for="(item, index) in imgUrlList" :key="item.id"
            ...
            <div class="right">
              <div class="cons" style="width: 220px;">
                <!-- 预览 -->
                <el-button class="file-but" v-if="isOperate" @click="handleViewer(item)"
                  style="vertical-align: middle;margin-left: 20px;" size="small" type="text">
                  <i class="iconfont icon-yulan"></i>{{ $t('button.preview') }}
                </el-button>
                <!-- 下载 -->
                <el-button class="file-but" v-if="isOperate" @click="downFilePath(item)" style="vertical-align: middle"
                  size="small" type="text">
                  <i class="iconfont icon-xiazaidaoru"></i>{{ $t('button.download') }}
                </el-button>
                <!-- 删除 -->
                <el-button class="file-but" v-if="!flowStatus" @click="deconsteFile(index)"
                  style="vertical-align: middle" size="small" type="text">
