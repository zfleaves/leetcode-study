...
const PageConfig = {
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 付款类型
            {show: true, prop: 'paymentValue', label: 'dialog.paymentValue'},
            // 实际支付金额
            {show: true, filterName: 'setMoney', prop: 'actualPaymentAmount', label: 'fConfig.actualPaymentAmount'},
            // 申请日期
            {show: true, filterName: 'date', prop: 'applyDate', label: 'fConfig.applyDate', minWidth: '120', align: 'center'}
        ]
    }
};
class Page {
