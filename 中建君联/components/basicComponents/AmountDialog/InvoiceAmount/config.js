...
const PageConfig = {
    ...
    mainTable: {
        ...
        tableList: [
            ...
            // 发票代码
            {show: true, prop: 'invoiceCode', label: 'dialog.invoiceCode'},
            // 发票号码
            {show: true, prop: 'invoiceNo', label: 'dialog.invoiceNo'},
            // 发票主要内容
            {show: true, prop: 'invoiceContent', label: 'dialog.invoiceContent'},
            // 价税合计
            {show: true, filterName: 'setMoney', prop: 'totalPriceTax', label: 'dialog.totalPriceTax'},
            // 开票日期
            {show: true, filterName: 'date', prop: 'invoiceDate', label: 'dialog.invoiceDate', minWidth: '120', align: 'center'}
        ]
    }
};
class Page {
